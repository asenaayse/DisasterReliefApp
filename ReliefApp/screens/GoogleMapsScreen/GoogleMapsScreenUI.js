...
const GoogleMapsScreenUI = ({ location }) => {
  //const initialLocation = location || center;
  // Depending on the platform, return the appropriate component
  if (Platform.OS === 'web') {
    return <GoogleMapsScreenUIWeb {...props} />;
  } else {
    return <GoogleMapsScreenUINative {...props} />;
  }
};
