...
import { GoogleMap, Marker, InfoWindow, LoadScript, DirectionsService, DirectionsRenderer } from '@react-google-maps/api';
      ...
      >
          ...
          <Marker
            ...
            icon={
              item.subCategory === "Electric_Heater"
                ? { url: require("../assets/heater_donation.svg") }
                : item.subCategory === "Blanket"
                ? { url: require("../assets/blanket_donation.svg") }
                : item.subCategory === "Painkiller"
                ? { url: require("../assets/painkiller_donation.svg") }
                : item.subCategory === "Bandage"
                ? { url: require("../assets/bandaid_donation.svg") }
                : item.subCategory === "Tent"
                ? { url: require("../assets/tent_donation.svg") }
                : item.subCategory === "Container"
                ? { url: require("../assets/container_donation.svg") }
                : item.subCategory === "Food"
                ? { url: require("../assets/food_donation.svg") }
                : item.subCategory === "Water"
                ? { url: require("../assets/water_donation.svg") }
        ...
        {needs.map(item => (
          <Marker
            ...
            icon={
              item.subCategory === "Electric_Heater"
                ? { url: require("../assets/heater_need.svg") }
                : item.subCategory === "Blanket"
                ? { url: require("../assets/blanket_need.svg") }
                : item.subCategory === "Painkiller"
                ? { url: require("../assets/painkiller_need.svg") }
                : item.subCategory === "Bandage"
                ? { url: require("../assets/bandaid_need.svg") }
                : item.subCategory === "Tent"
                ? { url: require("../assets/tent_need.svg") }
                : item.subCategory === "Container"
                ? { url: require("../assets/container_need.svg") }
                : item.subCategory === "Food"
                ? { url: require("../assets/food_need.svg") }
                : item.subCategory === "Water"
                ? { url: require("../assets/water_need.svg") }
        ...
        {selectedItem  &&  (
          ...
          >
            <div>
              ...
              < button onClick={()=>{
                setStart(""+selectedItem.locationLat+","+selectedItem.locationLng);
                routeLimit.current = 0;
                }}> Set as start point</button>
              < button onClick={()=>{
                setDestination(""+selectedItem.locationLat+","+selectedItem.locationLng);
                routeLimit.current = 0;;
